...
class Frame(object):
    ...
    def __init__(self):  # 构建基础用户界面的所有基本控件
        ...
        self.b2.grid(row=3, column=0, columnspan=1)
        
        self.label3=Label(self.root, text='正在爬取中……')
        self.label3.grid(row=3, column=0, columnspan=5, sticky=W)
...
class opentop2:
    def __init__(self):                                                                         # 构建设置用户界面的控件
        ...
        self.b9 = Button(self.top,text='设置URL参数',command=self.seturl)
        ...
        self.b10 = Button(self.top,text='设置URL列表文件',command=self.seturldoc)
